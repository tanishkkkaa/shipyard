...
const HeroSection = () => {
  return (
    <div className="flex justify-center items-center w-full">
        <div className="w-full max-w-screen-xl h-[18.5rem] lg:mt-[80px] mt-[30px] flex flex-col items-center  h-[584px] custom-background justify-center"> 
            ...
            <div className="flex flex-wrap sm:flex-nowrap  w-full  md:w-full justify-center items-center gap-4">
